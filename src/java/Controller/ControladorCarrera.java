...
public class ControladorCarrera extends Conexion {
    ...
    public String verCarreras(String user) {
        ...
        htmlcode = "          <div class=\"container\">\n"
                ...
                + "                                <h4 class=\"center yellow-text\">Facultad de Ciencias Económicas y Administrativas</h4>\n"
    ...
    public String editarCarrera(String carrera) {
        ...
        try {
            ...
            htmlcode = "                <div class=\"container\">\n"
                    + "                        <div class=\"row\">\n"
                    + "                            <h1 class=\"center yellow-text\">Actualización de la Carrera</h1>\n"
                    + "                        </div>\n"
                    + "                        <div class=\"row\">\n"
                    ...
                    + "                                        <label class=\"yellow-text\" for=\"descripcionCarreraAC\">Descripción</label>\n"
                    + "                                    </div>\n"
                    + "                                </div>\n"
                    + "                            </form>\n"
                    + "                        </div>\n"
    ...
    public String editarCoordinador(String carrera) {
        ...
        try {
            ...
            htmlcode = "                <div class=\"container\">\n"
                    + "                        <div class=\"row\">\n"
                    + "                            <h1 class=\"center yellow-text\">Actualización del Coordinador</h1>\n"
                    + "                        </div>\n"
                    + "                        <div class=\"row\">\n"
