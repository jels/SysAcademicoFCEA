...
public class ControladorAsignacionPractica extends Conexion {
        ...
        try {
            ...
            if (bandera) {
                ...
                htmlcode += "               <div class=\"container\">\n"
                        + "                        <form>\n"
                        + "                            <div class=\"row\">\n"
                        + "                                <h3 class=\"center\">El estudiante ya realiza Prácticas</h3>\n"
                        ...
                        + "                            </div>\n"
                        + "                            <div class=\"row\">\n"
                        + "                                <h5 class=\"center\">Área de Práctica: " + estudiante.getString(12) + "</h5>\n"
                        + "                            </div>\n"
                        + "                        </form>\n"
                        + "                    </div>";
                ...
                htmlcode += "                                            </optgroup>\n"
                        ...
                        + "                                        <label class=\"yellow-text\" for=\"Area de Practica\">Área de Práctica</label>\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "                            </div>\n"
                        + "                            <div class=\"row\">\n"
                        ...
                        + "                                    <label class=\"yellow-text\" for=\"Gestion Actual\">Gestión Actual</label>\n"
                        + "                                </div>\n"
                        + "                            </div>\n"
                        + "                            <div class=\"row\">\n"
                        + "                                <div class=\"col s6\">\n"
                        + "                                    <i class=\"material-icons prefix yellow-text\">date_range</i>\n"
                        + "                                    <label for=\"fechaInicioPra\" name=\"fechaInicioPra\" class=\"yellow-text\">Fecha Inicio Práctica</label>\n"
                        + "                                    <input id=\"fechaInicioPra\" type=\"date\" class=\"validate\">\n"
                        + "                                </div>\n"
                        + "                                <div class=\"col s6\">\n"
                        + "                                    <i class=\"material-icons prefix yellow-text\">date_range</i>\n"
                        + "                                    <label for=\"fechaFinPra\" name=\"fechaFinPra\" class=\"yellow-text\">Fecha Fin Práctica</label>\n"
                ...
                htmlcode += "                                        </select>\n"
                        ...
                        + "                                        <i class=\"material-icons prefix yellow-text\">business</i>\n"
                        + "                                        <input id=\"areaPractica\" name=\"areaPractica\" type=\"text\" class=\"validate\">\n"
                        + "                                        <label class=\"yellow-text\" for=\"areaPractica\">Área de Práctica</label>\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "                            </div>\n"
                        + "                            <div class=\"row\">\n"
                        ...
                        + "                                    <i class=\"material-icons prefix yellow-text\">date_range</i>\n"
                        + "                                    <input id=\"gestionActual\" name=\"gestionActual\" type=\"text\" class=\"validate\">\n"
                        + "                                    <label class=\"yellow-text\" for=\"gestionActual\">Gestión Actual</label>\n"
                        + "                                </div>\n"
                        + "                            </div>\n"
                        + "                            <div class=\"row\">\n"
                        + "                                <div class=\"col s6\">\n"
    ...
    public String verPracticasActivas() {
        ...
        try {
            htmlcode += "               <div class=\"container\">\n"
                    + "                        <div class=\"row\">\n"
                    + "                            <h3 class=\"center\">Prácticas activas de esta gestión</h3>\n"
                    + "                        </div>\n"
                    + "                        <div class=\"row\">\n"
