<%-- 
    Document   : perfil
    Created on : 04/12/2017, 03:23:00 PM
    Author     : WarMachine
--%>
                        ...
                        <div class="nav-content">
                            <div class="col s12">
                                <ul class="tabs blue darken-3 tabs-fixed-width">
                                    <li class="tab col s3"><a class="yellow-text" href="#datos">Datos del Usuario</a></li>
                                    <li class="tab col s3"><a class="yellow-text" href="#detalle">Editar</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div id="datos" class="col s12 blue darken-3 yellow-text">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col s3">
                                <br>
                                <img class="responsive-img materialboxed" src="../../img/fcea/tutores/Mario.jpg">
                            </div>
                            <div class="col s9">
                                <h3 class="center">Nombre completo del tutor</h3>
