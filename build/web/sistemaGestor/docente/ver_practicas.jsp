<%-- 
    Document   : ver_practicas
    Created on : 08/12/2017, 01:37:53 AM
    Author     : WarMachine
--%>
                        ...
                        <div class="nav-content">
                            <div class="col s12">
                                <ul class="tabs blue darken-3 tabs-fixed-width">
                                    ...
                                    <li class="tab col s4"><a class="yellow-text" href="#activos">Practicas Activas</a></li>
        ...
        <main>
            ...
            <div class="row blue darken-3 yellow-text">
                ...
                <div id="archivo" class="col s12 blue darken-3 yellow-text">
                    ...
                    <div class="container">
                        <div class="row">
                            <h3 class="center">Practicas Archivadas o Finalizadas</h3>                               
                        </div>
                        <div class="row">
