<%-- 
    Document   : asignar_practica
    Created on : 15/11/2017, 03:32:06 PM
    Author     : WarMachine
--%>
                        ...
                        <div class="nav-content">
                            <div class="col s12">
                                <ul class="tabs blue darken-3 tabs-fixed-width">
                                    <li class="tab col s12"><a class="yellow-text" href="#asignacion">Asignación de Práctica</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div id="asignacion" class="col s12 blue darken-3 yellow-text">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <h4 class="center red-text">No se le puede asignar Prácticas</h4>
                        </div>
                    </div>
